...
interface ProductDetailProps {
  ...
  onDirectCheckoutAdd?: (variant: Variant | null, quantity: number, finalPrice: number) => void;
}
...
export default function ProductDetail({ product,
  ...
  const handleAddToCart = useCallback(() => {
    ...
    if (isDirectCheckout && onDirectCheckoutAdd) {
      onDirectCheckoutAdd(variantToUse, quantity, pricingData.finalPrice);
      return true;
    }

    return addToCartOrPreOrder(variantToUse);
  }, [product.hasVariants, product.variantsId.length, selectedVariant, pricingData.defaultVariant, addToCartOrPreOrder, isDirectCheckout, onDirectCheckoutAdd, quantity, pricingData.finalPrice]);
    ...
    <div>
      <VariantSelectModal
        ...
        onSelect={(v, qty, finalPrice) => {
          ...
          if (isDirectCheckout && onDirectCheckoutAdd) {
            onDirectCheckoutAdd(v, qty, finalPrice);
          } else {
      ...
      {!isDirectCheckout && subCategoryId && (

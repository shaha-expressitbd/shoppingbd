...
export default function RefundPolicyPage() {
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-red-50 to-red-50 dark:from-red-900/20 dark:to-red-900/20 p-6 rounded-xl border border-red-200 dark:border-red-800">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-red-50 dark:from-slate-900 dark:via-red-900/20 dark:to-red-900/20 md:mt-16 mt-0">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-red-400/20 to-red-400/20 rounded-full blur-3xl animate-pulse"></div>
      ...
      <main className={`relative mx-auto max-w-7xl md:px-4 px-2 py-6 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        {/* Header */}
        <div className="text-center md:mb-16 mb-8">
          ...
          <h1 className="md:text-5xl text-xl font-bold bg-gradient-to-r from-red-600 via-red-600 to-orange-600 bg-clip-text text-transparent mb-4">
          ...
          {policyData.map((section, index) => (
            ...
            >
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 overflow-hidden hover:shadow-2xl transition-all duration-300">
                <div
                  className="flex items-center justify-between p-6 cursor-pointer hover:bg-gradient-to-r hover:from-red-50 hover:to-red-50 dark:hover:from-red-900/20 dark:hover:to-red-900/20 transition-all duration-300"
                    ...
                    {section.content || (
                      <div className="space-y-4 mb-2">
                        {section.items.map((item, itemIndex) => (
                          <div key={itemIndex} className="flex items-start space-x-3 p-4 rounded-lg bg-gradient-to-r from-red-50 to-red-50 dark:from-red-900/20 dark:to-red-900/20 border border-red-200 dark:border-red-800">
                            {item.icon}

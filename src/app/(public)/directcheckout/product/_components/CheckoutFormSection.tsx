...
import { CartSummary } from "../../../../(public)/checkout/_components/CartSummary";
import DeliveryInfoForm from "../../../../(public)/checkout/_components/DeliveryInfoForm";
...
const CheckoutFormSection = React.forwardRef<CheckoutFormRef, CheckoutFormSectionProps>(({ items, removeItem, updateItemQuantity, onBeforeSubmit, hideCartSummary }, ref) => {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        console.log("=== DIRECT CHECKOUT ORDER REQUEST PAYLOAD ===", orderPayload);
        ...
        <div className="relative">
            ...
            <div className="p-0">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 ">
                    <section className={`space-y-4 flex flex-col order-1 lg:order-2 ${hideCartSummary ? 'lg:col-span-8 lg:col-start-3' : 'lg:col-span-6'}`}>

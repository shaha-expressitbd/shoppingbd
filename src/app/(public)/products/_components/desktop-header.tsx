    ...
    <>
      ...
      <div className="relative w-full mt-16 mb-4 hidden md:flex xl:hidden">
        <input
          ...
          placeholder="Search…"
          className="w-full h-10 pl-5 pr-12 rounded-full bg-white dark:bg-gray-600 text-black dark:text-white border border-red-200 focus:outline-none focus:ring-2 focus:ring-primary"
        />
        <AiOutlineSearch
      ...
      {/* Desktop Header */}
      {!isMobile && (
        <div className="mb-2 md:mt-4 lg:mt-16 hidden md:flex items-center justify-between gap-4 px-2">
      ...
      {/* Mobile Header */}
      {isMobile && (
        <div className="md:hidden mt-4 mb-2 flex flex-col">

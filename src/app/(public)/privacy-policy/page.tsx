        ...
        <div className="space-y-4">
          <div className="grid gap-3">
            {[
              ...
              <div key={index} className="flex items-start space-x-3 p-3 rounded-lg bg-gradient-to-r from-red-50 to-red-50 dark:from-red-900/20 dark:to-red-900/20 border border-red-200 dark:border-red-800">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-red-50 to-red-50 dark:from-red-900/20 dark:to-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
      ...
      <main className={`relative mx-auto max-w-7xl md:px-4 px-2 md:py-12 py-6 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        <div className="text-center md:mb-16 mb-8">
          ...
          <p className="text-sm md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Learn how shoppersbd collects, uses, shares, and protects your data with complete transparency.
          </p>
        </div>

    ...
    >
      ...
      >
        <div className="relative rounded-2xl overflow-hidden bg-white dark:bg-black shadow-sm transition-transform duration-200 hover:-translate-y-0.5">
          ...
          {/* Product Image */}
          <div className="relative w-full aspect-[3/5] sm:aspect-[3/4] bg-red-50 dark:bg-black overflow-hidden rounded-xl">
            {isImageError ? (
  ...
  `}
            ...
            <button
              ...
              className={`absolute top-2 right-2 p-2 rounded-full border ${isWishlisted
                ...
                : "border-red-200 bg-white dark:bg-gray-700 text-primary"
          ...
          {/* Product Info */}
          <div className="p-3 sm:p-4 bg-red-50/40 dark:bg-black">

                    ...
                    <div className="col-span-12 relative md:px-4 sm:px-0 px-2">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary dark:text-gray-100 capitalize flex items-center justify-between">
                            ...
                            <div className="flex gap-2 ml-4">
                                <div className="p-2 rounded-full bg-secondary dark:bg-primary shadow dark:hover:bg-red-100 hover:bg-red-50 transition opacity-50">
                                    <div className="w-5 h-5 bg-gray-300 rounded animate-pulse"></div>
                                </div>
                                <div className="p-2 rounded-full bg-secondary dark:bg-primary shadow hover:bg-red-50 dark:hover:bg-red-100 transition opacity-50">
                                    <div className="w-5 h-5 bg-gray-300 rounded animate-pulse"></div>
                                </div>
                                <div className="px-2 py-2 text-sm bg-secondary dark:bg-primary text-gray-700 rounded shadow hover:bg-red-50 dark:hover:bg-red-100 transition opacity-50">
